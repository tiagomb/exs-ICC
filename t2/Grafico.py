...
x = [64, 128, 200, 256, 512, 600, 800, 1024, 2000, 3000, 4096, 6000, 7000, 10000, 50000, 100000, 1000000, 10000000, 100000000]
...
axs[1, 0].plot(x, vetor_dpGeraotim, label="dpComOtim", color="red")
axs[1, 0].plot(x, vetor_avxGeraotim, label="avxComOtim", color="green")
...
axs[2, 0].plot(x, vetor_ratioGeraotim, label="comOtim", color="blue")
axs[2, 0].set_ylabel("Cache miss ratio")
axs[2, 0].legend()

axs[3, 0].plot(x, vetor_memoryGera, label="semOtim", color="orange")
axs[3, 0].plot(x, vetor_memoryGeraotim, label="comOtim", color="blue")
...
axs[1, 1].plot(x, vetor_dpCalculaotim, label="dpComOtim", color="red")
axs[1, 1].plot(x, vetor_avxCalculaotim, label="avxComOtim", color="green")
axs[1, 1].set_xlabel("Número de pontos")
axs[1, 1].set_ylabel("FLOPS (MFlop/s)")
axs[1, 1].legend()

axs[2, 1].plot(x, vetor_ratioCalcula, label="semOtim", color="orange")
axs[2, 1].plot(x, vetor_ratioCalculaotim, label="comOtim", color="blue")
axs[2, 1].set_ylabel("Cache miss ratio")
axs[2, 1].legend()

axs[3, 1].plot(x, vetor_memoryCalcula, label="semOtim", color="orange")
axs[3, 1].plot(x, vetor_memoryCalculaotim, label="comOtim", color="blue")
axs[3, 1].set_ylabel("Memória (MByte/s)")
axs[3, 1].legend()
...
axs[1, 2].plot(x, vetor_dpResiduootim, label="dpComOtim", color="red")
axs[1, 2].plot(x, vetor_avxResiduootim, label="avxComOtim", color="green")
...
axs[2, 2].plot(x, vetor_ratioResiduootim, label="comOtim", color="blue")
axs[2, 2].set_ylabel("Cache miss ratio")
axs[2, 2].legend()

axs[3, 2].plot(x, vetor_memoryResiduo, label="semOtim", color="orange")
axs[3, 2].plot(x, vetor_memoryResiduootim, label="comOtim", color="blue")
